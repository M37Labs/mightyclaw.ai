...
import { PRODUCT_BRAND_CHAT_READY, PRODUCT_BRAND_LOGO_ALT } from "../../../../src/brand.ts";
import {
    ...
    <div class="agent-chat__welcome" style="--agent-color: var(--accent)">
      ...
      ${
        avatar
          ...
          : html`<div class="agent-chat__avatar agent-chat__avatar--logo"><img src=${logoUrl} alt=${PRODUCT_BRAND_LOGO_ALT} /></div>`
      }
      <h2>${name}</h2>
      <div class="agent-chat__badges">
        <span class="agent-chat__badge"><img src=${logoUrl} alt="" /> ${PRODUCT_BRAND_CHAT_READY}</span>
      </div>
