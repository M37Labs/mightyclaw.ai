...
async function requireRiskAcknowledgement(params: {
  ...
  await params.prompter.note(
    [
      "A quick safety pass before setup.",
      "",
      `Yes, it is safe ✅ when you keep it personal and review important warnings.`,
      `Yes, it is limited ✅ by the permissions, tools, and channels you choose.`,
      `Yes, it is tested ✅ but it is still powerful software and needs care.`,
      `Yes, it is iterative ✅ and the product will keep improving.`,
      "Yes, it stands on giants ✅ and builds on the OpenClaw open-source foundation.",
      "",
      `${PRODUCT_BRAND_NAME} works best as a personal system for one trusted operator.`,
      "If you enable tools, it may read files, open apps, and take actions on your behalf.",
      "That is useful, but it also means you should start small and stay intentional.",
      "",
      "Simple rules that matter:",
      "- Start with one person, one workspace, and one trusted setup.",
      "- Add channels one at a time.",
      "- Keep tool access narrow until you know exactly what you need.",
      "- Shared or multi-user setups need extra hardening and tighter boundaries.",
      "- If something looks critical, stop and fix it before moving on.",
      "",
      ...
      "Running them matters more than memorizing every line of output.",
      "Look out for critical issues first, then come back for the rest.",
      "",
      "Read before you expose it to other people or the internet:",
  ...
  const ok = await params.prompter.confirm({
    message: `I understand ${PRODUCT_BRAND_NAME} is best used as a personal, carefully configured system. Continue?`,
    initialValue: false,
  });
  if (!ok) {
