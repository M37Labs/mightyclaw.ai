...
const OPENCLAW_REPO_URL = "https://github.com/M37Labs/mightyclaw.ai.git";
const MAX_LOG_CHARS = 8000;

export const DEFAULT_PACKAGE_NAME = "@m37labs/mightyclaw";
const CORE_PACKAGE_NAMES = new Set(["openclaw", DEFAULT_PACKAGE_NAME]);

export function normalizeTag(value?: string | null): string | null {
  return normalizePackageTagInput(value, ["openclaw", "mightyclaw", DEFAULT_PACKAGE_NAME]);
}
