...
const DEFAULT_TAGLINE = `${PRODUCT_BRAND_NAME} by ${PRODUCT_BRAND_COMPANY}.`;
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—M37Labs packed the release, the logs are quiet, and the rollout can stay calm.",
...
const TAGLINES: string[] = [
  "M37Labs build quality, local-first control.",
  "One gateway, many channels, less drift.",
  "Automate the repetitive parts. Keep the sharp decisions.",
  "Workspace-first AI orchestration that still respects the shell.",
  "Built for shipping, debugging, and staying in context.",
  "If it is repeatable, it can be automated.",
  "Your gateway is local. Your control plane is finally coherent.",
  "Readable config, inspectable state, faster loops.",
  "Type less boilerplate. Review more signal.",
  "The dashboard is for control. The terminal is for momentum.",
  "Keep the agent close to the work and the logs closer.",
  "Local tools, remote reach, one mental model.",
  "Strong defaults, transparent state, fewer mysteries.",
  "Designed to survive real workflows, not just demos.",
  "The shell stays first-class here.",
  "Less tab drift, more shipped work.",
  "When the setup is clean, the iteration loop gets fast.",
  "MightyClaw keeps the moving parts in one place.",
  "Operate the gateway like infrastructure, not folklore.",
  "Built to be inspected, modified, and improved in public.",
